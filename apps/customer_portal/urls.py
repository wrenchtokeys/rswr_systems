...
urlpatterns = [
    ...
    path('repairs/<int:repair_id>/photos/<str:field>/', views.customer_repair_photo, name='customer_repair_photo'),
    ...
    path('replacements/<int:replacement_id>/photos/<str:field>/', views.customer_replacement_photo, name='customer_replacement_photo'),
