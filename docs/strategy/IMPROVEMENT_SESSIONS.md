...
| 2 | **B3** | **BUILT 2026-09-08** (PR #TBD) — spine 1 |
| 3 | **B5** | **NEXT — spine 2** |
| 4 | **B6** | NEXT — spine 3 |
...
| 2026-09-08 | **B3 built** as PR #TBD (quote → email → accept on link/portal → APPROVED jobs at the locked price; revise/expire/decline). Next in order is B5. |
