...
| P — Parts | P1 · Mygrant live quotes + ordering | M | TODO (portal verified with real creds 2026-08-14 — Appendix B.5; still pending Drake: ask Mygrant rep for API onboarding) |
...
## P1 · Mygrant live quotes + ordering — TODO (portal access verified 2026-08-14; blocked only on the rep API-onboarding call)
