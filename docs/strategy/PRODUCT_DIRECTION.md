...
**Last updated:** 2026-09-18 (**step 6 is complete in code**: its three fixes are on prod as `6cdb7a03` and its one session, **C3 · Findability**, is built and open as a PR. Step 7 — the selling, where the "no code" claim is true — is next. The five insurance interviews stay dropped as a gate, and Path B waits for a paying customer to ask.)
...
6. **Stranger-shop readiness** — **added 2026-09-18, and it contradicts what step 6 used to
   ...
   **#262** (the trial permitted 10 customers and 50 jobs a month as hard blocks, beside a
   ...
   on prod as of 2026-09-18 (`6cdb7a03`); C3 was what remained of this step and is now built,
   open as a PR.** #265 (technician
