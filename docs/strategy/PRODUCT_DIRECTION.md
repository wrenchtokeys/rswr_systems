...
**Last updated:** 2026-09-16 (B6 — the shop-owned price book — built as PR #257; B5 is PR #255; B3 is on prod since 2026-09-14. All three spine features are built; what is left is merge, deploy, and go-to-market)
...
5. **The three spine features, one session each** — **unblocked 2026-09-08** when the
   ...
   B5 (Tier 1 claim tracking, **built 2026-09-16, PR #255**), then B6 (price book, **built 2026-09-16, PR #257**). **All three are built**; merging and deploying #255 and #257, then `seed_price_book` once on prod, closes this step. Nothing else in this list is a session. One owner
